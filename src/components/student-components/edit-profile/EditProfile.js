...
import { createProfile, getCurrentProfile } from '../../../actions/student-actions/profileActions';
    ...
    if (nextProps.profile.profile) {
      ...
      profile.firstname = !isEmpty(profile.firstname) ? profile.firstname : '';
       profile.lastname= !isEmpty(profile.lastname) ? profile.lastname : '';
        profile.profile_created_by= !isEmpty(profile.profile_created_by) ? profile.profile_created_by : '';
        profile.location = !isEmpty(profile.location) ? profile.location : '';
         profile.need = !isEmpty(profile.need) ? profile.need : '';
          profile.race = !isEmpty(profile.race) ? profile.race : '';
           profile.resident = !isEmpty(profile.resident) ? profile.resident : '';
           profile.gpa = !isEmpty(profile.gpa) ? profile.gpa : '';
           profile.grade_level = !isEmpty(profile.grade_level) ? profile.grade_level : '';
           profile.degree = !isEmpty(profile.degree) ? profile.degree : '';


           profile.firstname = !isEmpty(profile.firstname) ? profile.firstname : '';
           profile.middle_initial = !isEmpty(profile.middle_initial ) ? profile.middle_initial  : '';
           profile.lastname = !isEmpty(profile.lastname) ? profile.lastname : '';
           profile.addressline1 = !isEmpty(profile.addressline1 ) ? profile.addressline1  : '';
          
           profile.addressline2 = !isEmpty(profile.addressline2 ) ? profile.addressline2  : '';
           ...
           // intermediate Step
           profile.personal_email= !isEmpty(profile.personal_email) ? profile.personal_email: '';
           profile.institute_email= !isEmpty(profile.institute_email) ? profile.institute_email: '';
           profile.ph_no1= !isEmpty(profile.ph_no1) ? profile.ph_no1: '';
           profile.ph_no1_type= !isEmpty(profile.ph_no1_type) ? profile.ph_no1_type: '';
  
           profile.ph_no2= !isEmpty(profile.ph_no2) ? profile.ph_no2: '';
           profile.ph_no2_type= !isEmpty(profile.ph_no2_type) ? profile.ph_no2_type: '';

           profile.ethnicity= !isEmpty(profile.ethnicity) ? profile.ethnicity: '';
           profile.race= !isEmpty(profile.race) ? profile.race: '';
        ...
        // final step
        profile.high_school_name= !isEmpty(profile.high_school_name) ? profile.high_school_name: ''; 
        profile.high_school_name= !isEmpty(profile.high_school_name) ? profile.high_school_name: '';
        profile.gpa= !isEmpty(profile.gpa) ? profile.gpa: '';
        profile.aid= !isEmpty(profile.aid) ? profile.aid: '';
        profile.extra_curricular= !isEmpty(profile.extra_curricular) ? profile.extra_curricular: '';
        profile.major_area_of_study= !isEmpty(profile.major_area_of_study) ? profile.major_area_of_study: '';
        profile.day= !isEmpty(profile.day) ? profile.day: '';
        profile.month= !isEmpty(profile.month) ? profile.month: '';
        profile.year= !isEmpty(profile.year) ? profile.year: '';
       
        profile.scholarship_type= !isEmpty(profile.scholarship_type) ? profile.scholarship_type: '';
        profile.student_time= !isEmpty(profile.student_time) ? profile.student_time: '';
        profile.created_by= !isEmpty(profile.created_by) ? profile.created_by: '';
        profile.other_scholarships= !isEmpty(profile.other_scholarships) ? profile.other_scholarships: '';
        profile.shop_locally= !isEmpty(profile.shop_locally) ? profile.shop_locally: '';
        profile.age_over= !isEmpty(profile.age_over) ? profile.age_over: '';
        profile.share_profile= !isEmpty(profile.share_profile) ? profile.share_profile: '';
      ...
      this.setState({
        ...
        addressline2:profile.addressline1,
        apt: profile.apt,
        city:profile.city,
        state: profile.state,
        zip: profile.zip,
        ...
        ph_no1: profile.ph_no1,
        ph_no1_type:  profile.ph_no1_type,
        ph_no2: profile.ph_no2,
        ph_no2_type: profile.ph_no2_type,
     ...
     major_area_of_study:profile.major_area_of_study,
     day:profile.day,
     month: profile.month,
     year:profile.year,
     scholarship_type:profile.scholarship_type ,
     student_time:profile.student_time,
     created_by: profile.created_by,
     other_scholarships:profile.other_scholarships,
     shop_locally:profile.shop_locally,
     age_over: profile.age_over,
           ...
           <div className="container">
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
                ...
                />
                  ...
                  info="Are you panning to shop locally *"
                />
                 </div>
                 <div className="col-lg-6 col-md-6 col-sm-12">
                   <SelectListGroup
