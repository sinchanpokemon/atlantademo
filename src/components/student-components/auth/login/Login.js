...
import LargeLogo from '../../../../assets/large-logo-transperent.png';
         ...
         <i className="  fa fa-angle-right learn-more"> Learn more about our premium subscription</i>
		    ...
		    <form onSubmit={this.onSubmit} className="">
             ...
             <TextFieldGroup  
                ...
                <hr/><br></br>
                <p className="paragraph-link">Don't have an account? <span className="learn-more"><Link to="/studentregister">Sign up now</Link></span></p>
