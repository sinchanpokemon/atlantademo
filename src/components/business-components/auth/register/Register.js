...
import { registerUser }from '../../../../actions/business-actions/authActions';
          ...
          <form onSubmit={this.onSubmit} className="">
            <label className="heading">Name </label>
               ...
               <TextFieldGroup  className="i"
                  ...
                  <hr/>
                  <p className="register-link">Have an account already? <span className="learn-more"><Link to="/bussinesslogin">Login</Link></span></p>
    
          </form>
      </div>
      <div className="col-md-6 text-center register-form-second-section">
      <img src={Handshake} alt=" Our Villager Logo" className="img-fluid" />
